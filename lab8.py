...
0	read r1            #gets n
1 	setn r2 0          #sets r2 to 0
2 	setn r3 1          #sets r3 to 1
3 	setn r4 0          #sets r4 to 0
4 	jeqzn r1 11        #if n = 0, it skips to line 11 and ends
5 	write r2           #return r2
6 	copy r4 r3         #sets r4 equal to r3
7 	add r3 r2 r3       #sets r3 equal to r3+r2
8 	copy r2 r4         #sets r2 equal to r4
9 	addn r1 -1         #sets r1 equal to r1-1
10 	jumpn 4            #jumps back to line 4
11 	halt               #ends the program
